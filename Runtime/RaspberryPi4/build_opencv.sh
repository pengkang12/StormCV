...
cmake -D WITH_OPENMP=ON -D BUILD_TIFF=ON -D WITH_FFMPEG=ON -D BUILD_TBB=OFF -D BUILD_TESTS=OFF -D WITH_EIGEN=ON -D WITH_GSTREAMER=ON -D WITH_V4L=ON -Wno-dev -D CMAKE_C_COMPILER=/usr/bin/gcc-7 -D CMAKE_CXX_COMPILER=/usr/bin/g++-7 -DCMAKE_PREFIX_PATH:PATH=../3rdparty/ -DCMAKE_INSTALL_PREFIX=../3rdparty/libjpeg -DCMAKE_INSTALL_PREFIX=../3rdparty/libjasper -DENABLE_PRECOMPILED_HEADERS=OFF ..
