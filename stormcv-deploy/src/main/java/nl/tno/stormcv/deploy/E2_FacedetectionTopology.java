...
public class E2_FacedetectionTopology {
	...
	public static void main(String[] args){
		...
		files.add( "file://"+ userDir +"/StormCV/stormcv-examples/resources/data/" ); // actual use of this directory depends on the fetcher. The ImageFetcher will read all image files present within the directory.
		...
		builder.setBolt("drawer", new SingleInputBolt(new DrawFeaturesOp().destination("file://"+userDir+ "/StormCV/stormcv-examples/output/facedetections/")), 1)
